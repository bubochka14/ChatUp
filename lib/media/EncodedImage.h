...
#include "api/boost::scoped_ptr.h"
#include "Buffer.h"
#include "VideoFrameType.h"
...
namespace webrtc {
    ...
    public:
        static boost::scoped_ptr <EncodedImageBuffer> Create() { return Create(0); }
        static boost::scoped_ptr<EncodedImageBuffer> Create(size_t size);
        static boost::scoped_ptr<EncodedImageBuffer> Create(const uint8_t* data,
            size_t size);
        static boost::scoped_ptr<EncodedImageBuffer> Create(Buffer buffer);
  ...
  /*      void SetPresentationTimestamp(
     ...
     /*       RTC_DCHECK_GE(spatial_index.value_or(0), 0);
        ...
        void SetEncodedData(boost::scoped_ptr<EncodedImageBufferInterface> encoded_data) {
        ...
        boost::scoped_ptr<EncodedImageBufferInterface> GetEncodedData() const {
    ...
    private:
        ...
        boost::scoped_ptr<EncodedImageBufferInterface> encoded_data_;
